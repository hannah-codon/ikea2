...
export default function ItemCarousel(props: ItemCarouselProps) {
  ...
  return (
    <div className="flex flex-col items-center w-[450px] h-[600px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 border rounded-xl shadow-md bg-white py-4">
      {items.map((item) => (
