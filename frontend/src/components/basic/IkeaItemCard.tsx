...
export function IkeaItemCard(props: IkeaItemCardProps) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden w-[350px] flex flex-col transition-transform transform hover:shadow-xl border border-gray-200">
